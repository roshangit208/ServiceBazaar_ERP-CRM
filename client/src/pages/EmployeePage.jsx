...
import DrawerForEmployee from '../components/DrawerForEmployee';
...
const EmployeePage = () => {
    ...
    const handleUpdateSubmit = async (e) => {
        e.preventDefault();
        return await axios.post(baseUrl + "update-employee/", formData, config);
    }
            ...
            <Layout>
                    ...
                    <ol className="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                        ...
                        <li>
                            <div className="flex items-center">
                                ...
                                <a href="#" className="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Employee</a>
                            </div>
                        </li>
                    </ol>
                </nav>
                <div className='w-[100%] mt-3 flex justify-end p-2'>
                    <DrawerForEmployee handleDataFromChild={handleDataFromChild} />
                    <div
                        id="drawer-example"
                    ...
                    >
                        ...
                        <div className="grid grid-cols-1 gap-4 text-start mt-20">
                            <form className="max-w-sm mx-auto" onSubmit={PromiseNotify}>
                                <div className="mb-5">
                                    <label for="website-admin" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white"> Employee Name</label>
                                    <div className="flex">
                                ...
                                <div className="mb-5">
                                    <label for="email-address-icon" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white"> Employee Email</label>
                                ...
                                <div className="mb-5">
                                    <label for="phone" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Employee Phone</label>
                ...
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            {employees?.map((employee) => (<tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                <td class="w-4 p-4">
                                    <div class="flex items-center">
                                ...
                                <td class="px-6 py-4">
                                    <a href="#" class="font-medium text-blue-600 dark:text-blue-500 hover:underline" onClick={() => { handleUpdate(employee); }} >Edit</a>
                                </td>
                            </tr>))}
                        </tbody>
                    </table>
