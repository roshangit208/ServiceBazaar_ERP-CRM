...
const AdminSetting = () => {
    ...
    const fetchAdmins = async () => {
        try {
            const { data } = await axios.get(baseUrl + "auth/get-admins", config);
            if (data) {
                setAdmins(data);
                console.log(data);
            }
    ...
    const handleUpdateSubmit = async (e) => {
        e.preventDefault();
        return await axios.post(baseUrl + "auth/update-admin/", formData, config);
    }
    ...
    const handleToggle = async (id) => {
        try {
           const enabledAdmin =  await axios.post(baseUrl + `auth/enable-admin/${id}`, {} ,config);
           setNewAdmin(enabledAdmin);
        } catch (err) {
            console.log(err);
        }
    };
            ...
            <Layout>
                    ...
                    <ol className="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                        ...
                        <li>
                            <div className="flex items-center">
                                ...
                                <a href="#" className="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Setting</a>
                            </div>
                        </li>
                        <li aria-current="page">
                            <div className="flex items-center">
                                ...
                                <span className="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Admin</span>
                            </div>
                        </li>
                    </ol>
                </nav>
                <div className='w-[100%] mt-3 flex justify-end p-2'>
                    <DrawerExample handleDataFromChild={handleDataFromChild} />
                    {<div
                        id="drawer-example"
                ...
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            {admins?.map((admin) => (<tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                <td class="w-4 p-4">
                                    <div class="flex items-center">
                                ...
                                <td class="px-6 py-4">
                                    ...
                                    <label className="inline-flex items-center cursor-pointer">
                                        <input
                                            ...
                                            onChange={() => { handleToggle(admin._id) }}
                                ...
                                <td class="px-6 py-4">
                                    <a href="#" class="font-medium text-blue-600 dark:text-blue-500 hover:underline" onClick={() => { handleUpdate(admin); }} >Edit</a>
                                </td>
                            </tr>))}
                        </tbody>
                    </table>
