...
const DrawerForClient = ({ handleDataFromChild }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        e.preventDefault();
        return await axios.post(baseUrl + "auth/add-client", formData, config);
    }
                ...
                >
                    ...
                    <div className="grid grid-cols-1 gap-4 text-start mt-20">
                        <form className="max-w-sm mx-auto" onSubmit={PromiseNotify}>
                            ...
                            <button type="submit" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"> Add Client Account</button>
                        </form>
                    </div>
                </div>
            </div>
...
export default DrawerForClient;
