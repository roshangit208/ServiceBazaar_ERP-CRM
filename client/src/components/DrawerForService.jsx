...
const DrawerForService = ({ handleDataFromChild }) => {
    const { userInfo } = useSelector((state) => (state.user));
    const [isDrawerOpen, setIsDrawerOpen] = useState(false);
    const initialState = userInfo?.role === "employee" ? { employeeId : userInfo._id } : {};
    ...
    const handleSubmit = async (e) => {
        ...
        e.preventDefault();
        return await axios.post(baseUrl + "add-service", formData, config);
    }
...
export default DrawerForService;